...
export const LIGHT_SURFACE_TEXT_FILL = MotionSensorColors.controlSurfaceTextColorProperty;

/**
 * Combo-box chrome for panels. Item labels must use {@link LIGHT_SURFACE_TEXT_FILL}, not
 * {@link MotionSensorColors.textColorProperty} — that color is for labels on the dark panel fill.
 */
export const MOTION_SENSOR_COMBO_BOX_OPTIONS = {
  buttonFill: MotionSensorColors.controlSurfaceColorProperty,
  listFill: MotionSensorColors.controlSurfaceColorProperty,
...
export const FLAT_PANEL_PUSH_BUTTON_OPTIONS = {
  ...
  baseColor: MotionSensorColors.controlSurfaceColorProperty,
} as const;
...
export const TIME_CONTROL_SPEED_RADIO_OPTIONS = {
  speedRadioButtonGroupOptions: {
    labelOptions: { fill: MotionSensorColors.textColorProperty },
  },
